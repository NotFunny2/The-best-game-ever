...
ans = input("what do you do? kill them or kill your kidnapper?: ")
...
elif ans == "kill my kidnapper":
    print("The fbi kills you cause they are bored lmao")

else:
    print("You broke the game congratulations")

print("The game is over go awayyyyyyyyyyyyyyyyyyyyyyyyyyy")
input("Type anything to close the gameeeeeeeeeeeeeeeeee ")